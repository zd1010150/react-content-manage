...
export const REMOVE_ENTITY_FROM_SELECTION = VIEWFILTER + 'REMOVE_ENTITY_FROM_SELECTION';
export const CHANGE_SELECTION = VIEWFILTER + 'CHANGE_SELECTION';
export const BATCH_ADD_TO_SELECTION = VIEWFILTER + 'BATCH_ADD_TO_SELECTION';
