...
class teamTree extends React.Component {
    ...
    render() {
      const {
        checkable, draggable, teams, defaultExpandAll, defaultSelectedKeys, defaultExpandedKeys, autoExpandParent, defaultCheckedKeys, expandedKeys, teamIds,
      } = this.props;
      return (
        <Tree
          expandedKeys={expandedKeys || this.state.expandedKeys || teamIds || []}
