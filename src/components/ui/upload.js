...
class PicturesWall extends React.Component {
    ...
    render() {
      const {
        uploadConfig, children, maxSize, isShowMaxSizeTip, isShowError,
      } = this.props;
      ...
      return (
        <div>
          ...
          {
                isShowError && this.state.isTypeError ? <p className="error-msg" > {formatMessage({ id: 'global.ui.upload.errorType' }, { type: uploadConfig.accept })} </p> : ''
            }
          {
              isShowError && this.state.isMaxSizeError ? <p className="error-msg"> {formatMessage({ id: 'global.ui.upload.errorMax' }, { size })} </p> : ''
            }

          { isShowMaxSizeTip ? <p className="error-msg"> {formatMessage({ id: 'global.ui.upload.maxSize' }, { size })} </p> : '' }
